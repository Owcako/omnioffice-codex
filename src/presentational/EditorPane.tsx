...
import HighlightWithinTextarea, { type Highlight } from "react-highlight-within-textarea";
...
const EditorPane = ({ value, placeholder, onChange, highlightRanges, editorRef }: EditorPaneProps) => {
